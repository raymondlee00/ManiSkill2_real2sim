...
from mani_skill2_real2sim.agents.base_agent import BaseAgent, Keyframe
from mani_skill2_real2sim.agents.controllers import *
# from mani_skill2_real2sim.agents.registration import register_agent
from mani_skill2_real2sim.sensors.camera import CameraConfig
from mani_skill2_real2sim.utils import common
# from mani_skill2_real2sim.utils.structs.actor import Actor
...
class UnitreeG1UpperBody(BaseAgent):
    ...
    def right_hand_is_grasping(self, object: sapien.Actor, min_force=0.5, max_angle=85):
